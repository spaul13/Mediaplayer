...
public class MediaPlayerCtrl : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (m_bFirst == false)
        {
            ...
            //Debug.Log("EasyMovieTextureCsharp in Update(), in bFirst");
	...
	Call_Load(strName,0);
            ...
            if (m_bSupportRockchip)
            {
                ...
                if (strName.Contains("://"))
                {
                    //Debug.Log("EasyMovieTextureCsharp in Update(), line 394 call Call_Load()");
                    Call_Load(strName, 0);
                }
                else
                {
            ...
            {
                //Debug.Log("EasyMovieTextureCsharp in Update(), line 406 call Call_Load()");
                Call_Load(strName, 0);
            }
...
#endif
            //Debug.Log("EasyMovieTextureCsharp in Update(), call Call_SetLooping");
        ...
        //Debug.Log("EasyMovieTextureCsharp, print m_CurrentState= " + m_CurrentState);

        if (m_CurrentState == MEDIAPLAYER_STATE.PLAYING || m_CurrentState == MEDIAPLAYER_STATE.PAUSED)
        {
            //Debug.Log("EasyMovieTextureCsharp, MediaState Playing or Paused, line 437");
            if (m_bCheckFBO == false)
            {

                //Debug.Log("EasyMovieTextureCsharp, m_bCheckFBO == false, line 441");
                //Debug.Log("EasyMovieTextureCsharp, return?? check width and height width=" + Call_GetVideoWidth() + "  height=" + Call_GetVideoHeight());

                if (Call_GetVideoWidth() <= 0 || Call_GetVideoHeight() <= 0)
                {
                    Debug.Log("EasyMovieTextureCsharp, return?? Call_GetVideoWidth() <= 0 || Call_GetVideoHeight() <= 0 line 444 width=" + Call_GetVideoWidth()+"  height=" + Call_GetVideoHeight());
                   // return;
                }
               ...
               // m_iHeight = 1024;
                ...
                //Debug.Log("EasyMovieTextureCsharp, before if (m_bPC_FastMode == true)");
                if (m_bPC_FastMode == true)
                {
                ...
                {
                    //Debug.Log("EasyMovieTextureCsharp, before m_texPtr = m_VideoTexture.GetNativeTexturePtr();");
                    m_texPtr = m_VideoTexture.GetNativeTexturePtr();
                    //Debug.Log("EasyMovieTextureCsharp, after m_texPtr = m_VideoTexture.GetNativeTexturePtr();");
                }
                ...
                Debug.Log("EasyMovieTextureCsharp, before m_texPtr = m_VideoTexture.GetNativeTexturePtr();  588");
				m_texPtr = m_VideoTexture.GetNativeTexturePtr ();
                Debug.Log("EasyMovieTextureCsharp, after m_texPtr = m_VideoTexture.GetNativeTexturePtr();   590");
#endif

                //Debug.Log("EasyMovieTextureCsharp, before Call_SetUnityTexture((int)m_texPtr);, line 589");
#if UNITY_5_2 || UNITY_5_3_OR_NEWER
                //Debug.Log("EasyMovieTextureCsharp, Call_SetUnityTexture((int)m_texPtr);, line 591");
	...
	Call_SetUnityTexture (m_VideoTexture.GetNativeTextureID ());
        ...
        //Debug.Log("EasyMovieTextureCsharp, test status change, m_CurrentState = "+ m_CurrentState +" Call_GetStatus() = " + Call_GetStatus());
        if (m_CurrentState != Call_GetStatus())
        {
            ...
            if (m_CurrentState == MEDIAPLAYER_STATE.READY)
            {
                ...
                if (m_bAutoPlay)
                {
                    //Debug.Log("EasyMovieTextureCsharp, line 632 Call_Play(0)");
                    Call_Play(0);
                }
                if (m_bReadyPlay)
                {
                    //Debug.Log("EasyMovieTextureCsharp, line 637 Cll_Play(0)");
                    Call_Play(0);
                    m_bReadyPlay = false;
                }
            ...
            else if (m_CurrentState == MEDIAPLAYER_STATE.END)
            {
                ...
                if (m_bLoop == true)
                {
                    //Debug.Log("EasyMovieTextureCsharp, line 654 Cll_Play(0)");
                    Call_Play(0);
                }
            }
    ...
    public void Play()
    {
        if (m_bStop == true)
        {
            Debug.Log("\n In unity Just before calling seekto");
            SeekTo(0);
            Debug.Log("EasyMovieTextureCsharp, line 1142 Cll_Play(0)");
            Call_Play(0);
            m_bStop = false;
        }
        ...
        {
            Debug.Log("EasyMovieTextureCsharp, line 1153 Call_Play(0)");
            Call_Play(0);
        }
    ...
    {
        Debug.Log("\n from unity seekto function, the iseek position is =" + iSeek + " and current state = " + m_CurrentState);
    ...
    public void SetSeekBarValue(float fValue)
    {
        if (m_CurrentState == MEDIAPLAYER_STATE.PLAYING || m_CurrentState == MEDIAPLAYER_STATE.PAUSED || m_CurrentState == MEDIAPLAYER_STATE.END || m_CurrentState == MEDIAPLAYER_STATE.READY || m_CurrentState == MEDIAPLAYER_STATE.STOPPED)
        {
            ...
            Debug.Log("\n from unity setseekbarvalue function, the duration of video is =" + GetDuration() + " and current state = " + m_CurrentState);
	...
	{
    Debug.Log("EasyMovieTextureCsharp, line 1396 Call_Load()");
#if UNITY_5
	if( SystemInfo.graphicsMultiThreaded == true)
	{
    Debug.Log("EasyMovieTextureCsharp, line 1400 GetJavaObject()");
    ...
    Debug.Log("EasyMovieTextureCsharp, line 1408 Call_SetNotReady()");
	Call_SetNotReady();
	...
	{
    Debug.Log("EasyMovieTextureCsharp, line 1416 GetJavaObject()");
	GetJavaObject().Call("NDK_SetFileName", strFileName);
    ...
    private void Call_SetDirection(int direction)
    {
        Debug.Log("EasyMovieTextureCsharp, Call_setDirection");
        GetJavaObject().Call("setDirection",direction);
    }
	...
	{
    Debug.Log("EasyMovieTextureCsharp, line 1530 Call_Play");
	...
	{
    //Debug.Log("EasyMovieTextureCsharp, line 1704, Call_GetStatus");
	...
	private bool Call_Load(string strFileName, int iSeek)
	{
    Debug.Log("EasyMovieTextureCsharp, line 1866, call Call_Load()");
	if( m_iID == -1)
	{
	Call_SetUnityActivity();
	}
	...
	private void Call_Play(int iSeek)
	{
    Debug.Log("EasyMovieTextureCsharp, line 1984, Call_Play");
	float fSeek = (float)iSeek / 1000.0f;
	...
	private MEDIAPLAYER_STATE Call_GetStatus()
	{
    Debug.Log("EasyMovieTextureCsharp, line 2094, Call_GetStatus");
    ...
    {
        Debug.Log("EasyMovieTextureCsharp, in unsafe Call_Load");
        fCurrentSeekTime = 0.0f;
        fLastFrameTime = 0.0f;
        iSoundCount = 0;
        iInitCount = 0;
    ...
    void LoadVideoPart2()
    {
        ...
        Debug.Log("EasyMovieTextureCsharp-before auto play");
        if (m_bAutoPlay == true)
        {
            if (OnReady != null)
                OnReady();

            Debug.Log("EasyMovieTextureCsharp m_CurrentState = MEDIAPLAYER_STATE.PLAYING");
            m_CurrentState = MEDIAPLAYER_STATE.PLAYING;
        ...
        else
        {
            ...
            Debug.Log("EasyMovieTextureCsharp m_CurrentState = MEDIAPLAYER_STATE.READY");
            ...
            //do
            {
                ...
                if (listVideo.Count > 0)
                {
                    ...
                    else
                    {
                        ...
                        GL.IssuePluginEvent(GetRenderEventFunc(), 7000 + m_iID); //avoid interfereing render thread for native plugin
                    }
	...
	audioSource.time = fLastFrameTime;
                ...
                {
                    Debug.Log("\n from unity, If video first frame is ready");
                    if (OnVideoFirstFrameReady != null)
                    {
                        OnVideoFirstFrameReady();
                        bVideoFirstFrameReady = false;
    ...
    private void Call_Play(int iSeek)
    {
        Debug.Log("EasyMovieTextureCsharp, line 3881 Call_Play(int iSeek)");
    ...
    private void Call_SetUnityTexture(int iTextureID)
    {
        Debug.Log("The texture id is ="+ iTextureID);
    }
    ...
    private MEDIAPLAYER_STATE Call_GetStatus()
    {
        Debug.Log("EasyMovieTextureCsharp, line 4028, Call_GetStatus");
        return m_CurrentState;
    }
